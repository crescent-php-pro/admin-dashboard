...
var blankHTML = env.isMSIE && env.browserVersion < 11 ? '&nbsp;' : '<title>Printed by CRESCENT GENIIUS</title><br>';
/**
 * @method nodeLength
 *
...
function dom_isEmpty(node) {
  ...
  if (len === 0) {
    ...
    // ex) <title>Crescent Geniius</title><p><br></p>, <span><br></span>
    return true;
  } else if (lists.all(node.childNodes, isText) && node.innerHTML === '') {
    // ex) <title>Crescent Geniius</title><p></p>, <span></span>
    return true;
  }
...
var HelpDialog_HelpDialog = /*#__PURE__*/function () {
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function initialize() {
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<p class="text-center">', '<a href="#">Nunuget Inc</a> · ', '<a href="#">3.1.0</a>','</p>'].join('');
      this.$dialog = this.ui.dialog({
